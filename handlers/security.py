...
_HELP_TEXT = (
    "🤖 <b>Company Assistant</b>\n"
    "\n"
    "📋 <b>Tasks</b>\n"
    "<code>/add &lt;text&gt;</code> — Add a task "
    "(e.g. <code>/add Buy domain</code>). "
    "Reply to any message with <code>/add</code> to turn it into a task. "
    "Tap ✅ on <code>/list</code> to complete one.\n"
    "<code>/list</code> — See all open tasks\n"
    "<code>/braindump &lt;text&gt;</code> — Paste a big chunk of tasks; "
    "I'll split them into a list for you to confirm\n"
    "\n"
    "🧠 <b>Memory</b>\n"
    "<code>/note &lt;text&gt;</code> — Save something to remember "
    "(e.g. <code>/note Stripe fee is 2.9% + 30¢</code>)\n"
    "<code>/ask &lt;question&gt;</code> — Ask about anything discussed before "
    "or coming up (e.g. <code>/ask What's on this week?</code>)\n"
    "\n"
    "📅 <b>Calendar</b>\n"
    "<code>/planevent &lt;text&gt;</code> — Add an event in plain English "
...
async def welcome_new_member(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    for member in update.message.new_chat_members:
        ...
        await update.message.reply_text(
            ...
            "I'm the company assistant — a shared bot for "
            "<b>tasks</b>, <b>memory</b>, and "
